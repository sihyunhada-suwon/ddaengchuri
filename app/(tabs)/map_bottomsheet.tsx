...
// import FilterBottomSheet from './filter'; // ⬅️ filter.tsx가 이 컴포넌트
...
//   const filterModalRef = useRef<BottomSheetModal>(null); // ⬅️ filter 바텀시트 모달 참조
...
//           {showFilter && (
//             <TouchableOpacity style={styles.filterIconBox} onPress={openFilter}>
...
//       >
//         <FilterBottomSheet onClose={() => filterModalRef.current?.dismiss()} />
//       </BottomSheetModal>
//     </BottomSheetModalProvider>
//   );
// }
